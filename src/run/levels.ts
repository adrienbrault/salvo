...
export const SECTOR_NAMES = ['Low Orbit', 'Debris Belt', 'Red Nebula', 'The Core'] as const;

export const sectorName = (s: number): string => SECTOR_NAMES[s] ?? `Abyss ${s - SECTOR_NAMES.length + 1}`;
